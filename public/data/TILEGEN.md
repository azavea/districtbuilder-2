...
tippecanoe -f -o mbtiles/city-l.mbtiles --maximum-zoom=12 --minimum-zoom=1 --feature-filter='{ "*": [ "==", "statefp", "42" ] }' city-l.geojson
tippecanoe -f -o mbtiles/city-m.mbtiles --maximum-zoom=12 --minimum-zoom=2 --feature-filter='{ "*": [ "==", "statefp", "42" ] }' city-m.geojson
tippecanoe -f -o mbtiles/city-s.mbtiles --maximum-zoom=12 --minimum-zoom=4 --feature-filter='{ "*": [ "==", "statefp", "42" ] }' city-s.geojson
tippecanoe -f -o mbtiles/town-l.mbtiles --maximum-zoom=12 --minimum-zoom=7 --drop-densest-as-needed --feature-filter='{ "*": [ "==", "statefp", "42" ] }' town-l.geojson
tippecanoe -f -o mbtiles/town-m.mbtiles --maximum-zoom=12 --minimum-zoom=7 --drop-densest-as-needed --feature-filter='{ "*": [ "==", "statefp", "42" ] }' town-m.geojson
tippecanoe -f -o mbtiles/town-s.mbtiles --maximum-zoom=12 --minimum-zoom=8 --drop-densest-as-needed --feature-filter='{ "*": [ "==", "statefp", "42" ] }' town-s.geojson
